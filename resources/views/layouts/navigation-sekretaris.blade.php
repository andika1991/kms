<aside class="fixed inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-200 flex-col hidden lg:flex">
    ...
    <nav class="flex-1 px-4 py-4 space-y-2">
        ...
        <a href="{{ route('sekretaris.dashboard') }}"
            ...
            <i
                class="fa-solid fa-house w-6 text-center {{ request()->routeIs('kepalabagian.dashboard') ? 'text-white' : 'text-gray-400' }} text-lg"></i>
            <span>Dashboard</span>
        </a>
        ...
        <a href="{{ route('sekretaris.berbagipengetahuan.index') }}"
            ...
            <i
                class="fa-solid fa-file-alt w-6 text-center {{ request()->routeIs('kepalabagian.artikelpengetahuan.*') ? 'text-white' : 'text-gray-400' }} text-lg"></i>
        ...
        <a href="{{ route('sekretaris.manajemendokumen.index') }}"
            ...
            <i
                class="fa-solid fa-folder-open w-6 text-center {{ request()->routeIs('sekretaris.manajemendokumen.*') ? 'text-white' : 'text-gray-400' }} text-lg"></i>
        ...
        <a href="{{ route('sekretaris.forum.index') }}"
            ...
            <i
                class="fa-solid fa-comments w-6 text-center {{ request()->routeIs('kepalabagian.forum.*') ? 'text-white' : 'text-gray-400' }} text-lg"></i>
        ...
        <a href="{{ route('sekretaris.agenda.index') }}"
          ...
          {{ request()->routeIs('sekretaris.agenda.*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-600 hover:bg-gray-100' }}">
            <i
                class="fa-solid fa-users-gear w-6 text-center {{ request()->routeIs('manajemenpengguna.*') ? 'text-white' : 'text-gray-400' }} text-lg"></i>
