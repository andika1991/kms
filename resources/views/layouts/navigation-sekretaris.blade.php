        ...
        <nav class="flex-1 px-4 py-4 space-y-2">
            <a href="{{ route('sekretaris.dashboard') }}"
                class="flex items-center gap-4 px-4 py-3 rounded-lg font-semibold text-base transition
                    {{ request()->routeIs('sekretaris.dashboard') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-600 hover:bg-gray-100' }}">
                <i class="fa-solid fa-house w-6 text-center {{ request()->routeIs('sekretaris.dashboard') ? 'text-white' : 'text-gray-400' }} text-lg"></i>
                <span>Dashboard</span>
            </a>
            <a href="{{ route('sekretaris.berbagipengetahuan.index') }}"
                ...
                <i class="fa-solid fa-file-alt w-6 text-center {{ request()->routeIs('sekretaris.berbagipengetahuan.*') ? 'text-white' : 'text-gray-400' }} text-lg"></i>
            ...
            <a href="{{ route('sekretaris.forum.index') }}"
                ...
                <i class="fa-solid fa-comments w-6 text-center {{ request()->routeIs('sekretaris.forum.*') ? 'text-white' : 'text-gray-400' }} text-lg"></i>
            ...
            <a href="{{ route('sekretaris.agenda.index') }}"
                ...
                <i class="fa-solid fa-users-gear w-6 text-center {{ request()->routeIs('sekretaris.agenda.*') ? 'text-white' : 'text-gray-400' }} text-lg"></i>
