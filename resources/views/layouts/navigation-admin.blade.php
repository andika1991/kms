        ...
        <nav class="flex-1 px-4 py-4 space-y-2">
            ...
            <a href="{{ route('admin.manajemendokumen.index') }}"
               class="flex items-center gap-4 px-4 py-3 rounded-lg font-semibold text-base transition
                ...
                <i class="fa-solid fa-folder-open w-6 text-center {{ request()->routeIs('admin.manajemendokumen.*') ? 'text-white' : 'text-gray-400' }} text-lg"></i>
            ...
            <a href="{{ route('admin.kegiatan.index') }}"
               class="flex items-center gap-4 px-4 py-3 rounded-lg font-semibold text-base transition
                ...
                <i class="fa-solid fa-calendar-days w-6 text-center {{ request()->routeIs('admin.kegiatan.*') ? 'text-white' : 'text-gray-400' }} text-lg"></i>
            ...
            <a href="{{ route('admin.manajemenpengguna.index') }}"
               class="flex items-center gap-4 px-4 py-3 rounded-lg font-semibold text-base transition
                ...
                <i class="fa-solid fa-users-gear w-6 text-center {{ request()->routeIs('admin.manajemenpengguna.*') ? 'text-white' : 'text-gray-400' }} text-lg"></i>
