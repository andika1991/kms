...
<x-app-layout>
        ...
        <div class="bg-white shadow-lg rounded-2xl border border-gray-200">
            ...
            @else
                ...
                <div class="px-6 py-14">
                    <div class="rounded-2xl border-2 border-dashed border-slate-300/80 bg-slate-50 p-10 sm:p-14 flex flex-col items-center justify-center text-center shadow-inner">
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
            ...
            <form id="form-kunci">
                ...
                <input type="password" name="encrypted_key" placeholder="Kunci rahasia"
                       class="w-full rounded-xl border border-gray-300 mb-4 px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none" required>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        form.addEventListener('submit', e => {
            ...
            if (!key) { alert('Kunci tidak boleh kosong!'); return; }
