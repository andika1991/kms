<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4">
                <a href="{{ route('magang.kegiatan.create') }}" class="inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                    + Tambah Kegiatan
                </a>
            </div>
                        ...
                        @forelse ($kegiatan as $item)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200">
                                    <a href="{{ route('magang.kegiatan.edit', $item->id) }}" class="text-blue-600 hover:underline">Edit</a>
