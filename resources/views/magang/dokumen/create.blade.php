        ...
        <div class="px-4 md:px-8 grid grid-cols-1 xl:grid-cols-12 gap-8 mt-6">
            ...
            <aside class="xl:col-span-4 w-full flex flex-col gap-8 mt-8 xl:mt-0">
                <div
                    ...
                    <div>
                        <p class="font-bold text-lg leading-tight mb-2">
                            Bidang {{ Auth::user()->role->nama_role ?? 'Magang' }}</p>
                ...
                <div class="flex flex-col md:flex-row items-center gap-4">
                    ...
                    <a href="{{ route('magang.manajemendokumen.index') }}" class="w-full flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-red-700 hover:bg-red-800 text-white font-semibold shadow-sm transition text-base">
