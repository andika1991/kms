...
@section('title', 'Tambah Artikel Kasubbidang')


<x-app-layout>
    <div class="w-full min-h-screen bg-[#eaf5ff] pb-32"> {{-- Padding bawah agar footer tidak tabrakan --}}
        {{-- HEADER --}}
        ...
        {{-- FORM TAMBAH ARTIKEL --}}
        <form id="edit-artikel-form" method="POST" action="{{ route('kasubbidang.berbagipengetahuan.store') }}" enctype="multipart/form-data"
            ...
            <aside class="xl:col-span-4 w-full flex flex-col gap-6">
                ...
                <div class="flex flex-col md:flex-row items-center gap-4">
                    <button id="btn-create-artikel" type="submit"
