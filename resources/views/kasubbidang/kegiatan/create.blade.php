    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
                ...
                <form id="form-kegiatan" method="POST" action="{{ route('kasubbidang.kegiatan.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <select name="kategori_kegiatan" id="kategori_kegiatan"
                            ...
                            <option value="publik" {{ old('kategori_kegiatan') == 'publik' ? 'selected' : '' }}>
                                Publik
                            </option>
                            <option value="internal" {{ old('kategori_kegiatan') == 'internal' ? 'selected' : '' }}>
                                Internal
                            </option>
                        </select>
