<x-app-layout>
    ...
    <div class="py-6 max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 p-6 rounded shadow">
            <form method="POST" action="{{ route('kasubbidang.manajemendokumen.update', $manajemendokuman->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    @if($manajemendokuman->path_dokumen)
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                            File saat ini: 
                            <a href="{{ asset('storage/' . $manajemendokuman->path_dokumen) }}" target="_blank" class="text-blue-600 underline">
