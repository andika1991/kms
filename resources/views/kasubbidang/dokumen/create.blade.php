...
@section('title', 'Tambah Dokumen Kasubbidang')
...
<div class="w-full min-h-screen bg-[#eaf5ff] flex flex-col pb-10">
    ...
    <div class="px-4 md:px-8 grid grid-cols-1 xl:grid-cols-12 gap-8 mt-6">
        <form method="POST" action="{{ route('kasubbidang.manajemendokumen.store') }}" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-7">
                ...
                <div class="flex flex-col items-center justify-center h-full">
                    <label for="path_dokumen" class="w-full">
                        <div
                            class="border-2 border-gray-300 border-dashed rounded-xl h-60 flex flex-col justify-center items-center cursor-pointer hover:bg-gray-50 transition relative">
                            ...
                            <input type="file" name="path_dokumen" id="path_dokumen"
                                class="absolute w-full h-full opacity-0 top-0 left-0 cursor-pointer" required>
                            <span id="file-name" class="block text-gray-600 text-sm mt-2"></span>
                        </div>
                    </label>
                    @error('path_dokumen')
        ...
        <aside class="xl:col-span-4 w-full flex flex-col gap-8">
            ...
            <div class="flex gap-4">
                <button type="button" id="btn-create-dokumen"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // SweetAlert2 Modal (Konfirmasi Simpan)
    document.getElementById('btn-create-dokumen').addEventListener('click', function(e) {
        ...
        Swal.fire({
            ...
            customClass: {
                confirmButton: 'bg-green-600 hover:bg-green-700 text-white font-semibold px-10 py-2 rounded-lg mx-2',
                cancelButton: 'bg-red-700 hover:bg-red-800 text-white font-semibold px-10 py-2 rounded-lg mx-2'
            }
        }).then((result) => {
