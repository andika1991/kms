<x-app-layout>
    ...
    <div class="py-6 max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 p-6 rounded shadow">
            <form method="POST" action="{{ route('kasubbidang.forum.store') }}">
                @csrf
...
<div id="bidang-field" class="mb-4">
    ...
    <select name="bidang_id" class="w-full rounded border-gray-300 dark:bg-gray-700 dark:text-gray-200" readonly>
