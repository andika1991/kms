<x-app-layout>
    <div 
        ...
        class="fixed inset-0 flex items-center justify-center min-h-screen bg-gray-200"
        style="z-index:30;"
    >
        {{-- Modal Edit Kategori --}}
        <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md flex flex-col items-center border border-gray-200 animate-fade-in">
