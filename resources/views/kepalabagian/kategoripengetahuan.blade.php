...
@section('title', 'Kategori Pengetahuan')
        ...
        <div class="p-6 md:p-8 grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <section class="xl:col-span-8 w-full">
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200/80">
                    <div
                        class="flex flex-col sm:flex-row items-center justify-between px-6 py-4 border-b border-gray-200 gap-4">
                        <span class="font-bold text-lg text-blue-700 border-b-4 border-blue-600 pb-2">
                            Pengetahuan
                        </span>
                        <div class="flex items-center gap-3">
                            <button
                                class="flex items-center gap-2 border border-gray-300 rounded-lg px-4 py-1.5 bg-white hover:bg-gray-50 text-gray-700 font-medium shadow-sm transition text-sm">
                                <span>Urut</span>
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex flex-col items-center justify-center text-center py-20 px-6">
                            ...
                            <p class="text-gray-500 mt-2">Saat ini belum ada data kategori pengetahuan yang tersedia.
                            </p>
                        </div>
                        @endif
                    </div>
