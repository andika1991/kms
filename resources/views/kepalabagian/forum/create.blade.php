<x-app-layout>
            ...
            <form method="POST" action="{{ route('kepalabagian.forum.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="deskripsi" rows="4"
                        class="w-full rounded border-gray-300 dark:bg-gray-700 dark:text-gray-200">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
  ...
  <div class="mb-4">
    ...
    <select id="user-select" name="pengguna_id[]" multiple placeholder="Cari dan pilih anggota grup..."
        class="w-full rounded border-gray-300 dark:bg-gray-700 dark:text-gray-200">
...
<div id="bidang-field" class="mb-4">
    <label class="block text-gray-700 dark:text-gray-200">Bidang (Untuk Grup Umum)</label>
    <select name="bidang_id" class="w-full rounded border-gray-300 dark:bg-gray-700 dark:text-gray-200">
