        ...
        <div class="p-6 md:p-8 grid grid-cols-1 xl:grid-cols-12 gap-8 flex-grow">
            ...
            <section class="xl:col-span-8 w-full">
                @forelse($grupchats as $grupchat)
                    ...
                    <a href="{{ route('kepalabagian.forum.show', $grupchat->id) }}" class="block bg-white rounded-2xl shadow-lg border border-gray-200/80 p-6 mb-6 hover:shadow-xl hover:border-blue-300 transition-all duration-300">
                        ...
                        <div class="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                            <div class="flex items-center -space-x-2">
                                <img class="w-8 h-8 rounded-full border-2 border-white" src="{{ asset('assets/img/avatar-placeholder.png') }}" alt="User 1">
                                <img class="w-8 h-8 rounded-full border-2 border-white" src="{{ asset('assets/img/avatar-placeholder.png') }}" alt="User 2">
                                <div class="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center text-xs font-semibold text-gray-600 border-2 border-white">+5</div>
                            </div>
            ...
            <aside class="xl:col-span-4 w-full flex flex-col gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-7 space-y-3">
                    <a href="{{ route('kepalabagian.forum.create') }}" class="w-full flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-green-600 hover:bg-green-700 text-white font-semibold shadow-sm transition text-base">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-7">
                    <p class="text-sm text-gray-600 leading-relaxed">
                        Forum Diskusi merupakan fitur untuk mempermudah pegawai Dinas Komunikasi, Informatika dan Statistik Provinsi Lampung dapat saling berbagi pengetahuan dan memepermudah komunikasi dengan manajemen yang terstruktur dan mudah diakses.
                    </p>
                </div>
            </aside>
        </div>
