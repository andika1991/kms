                ...
                <section class="xl:col-span-8 w-full">
                    <div class="bg-white rounded-2xl shadow-lg p-4 md:p-10 flex flex-col gap-4">
                        ...
                        <nav class="mb-1 text-xs text-gray-400">
                            <a href="{{ route('sekretaris.manajemendokumen.index') }}" class="hover:underline">Dokumen
                                &gt; Daftar Dokumen</a>
                        </nav>
                        ...
                        <div class="flex flex-wrap gap-x-4 gap-y-1 text-sm text-gray-500">
                            <div>
                                <span>Kategori:</span>
                                <span
                                    class="font-semibold text-blue-600">{{ $dokumen->kategoriDokumen->nama_kategoridokumen ?? '-' }}</span>
                            </div>
                            ...
                            <div class="flex flex-col items-end gap-2 w-full sm:w-auto">
                                ...
                                <div class="flex items-center gap-2 text-gray-500">
                                    ...
                                    <div class="flex -space-x-2">
                                        ...
                                        @if($viewers->count() > 5)
                                        <div
                                            class="w-6 h-6 rounded-full bg-gray-200 border-2 border-white text-[10px] flex items-center justify-center shadow">
                                            +{{ $viewers->count() - 5 }}
                                        </div>
                                        @endif
                                    </div>
