                ...
                <div class="bg-white rounded-2xl shadow-lg p-5">
                    ...
                    <ul class="space-y-3">
                        @forelse($dokumenTerbaru as $index => $dokumen)
                            <li class="flex justify-between items-center text-sm text-gray-700 {{ $index % 2 == 0 ? 'bg-[#f3f7fb]' : 'bg-white' }} px-3 py-2 rounded-md">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="bg-white rounded-2xl shadow-lg p-6">
                    ...
                    <p class="text-sm text-gray-700 leading-relaxed">
                        ...
                        informasi dan dokumentasi strategis bagi seluruh pegawai di lingkungan instansi. Melalui tampilan
      ...
      new Chart(el.getContext('2d'), {
        ...
        options: {
          ...
          scales: {
            x: {
              grid: { display: false },
              ticks: { autoSkip: true, autoSkipPadding: 12, maxRotation: 0, minRotation: 0 }
            },
            y: {
              beginAtZero: true,
