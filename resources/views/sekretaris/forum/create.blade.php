...
<x-app-layout>
    <div class="bg-[#eaf5ff] min-h-screen w-full flex flex-col">
        ...
        {{-- MAIN CONTENT + SIDEBAR (form wrap) --}}
            ...
            <div class="flex-1">
                <div class="bg-white rounded-2xl shadow-lg px-6 md:px-12 py-8 flex flex-col gap-6 max-w-2xl mx-auto">
                    ...
                    <div id="users-field" class="hidden">
                        ...
                        <small class="text-gray-500">Ketik untuk mencari dan pilih anggota (bisa lebih dari
                            satu).</small>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        isPrivateCheckbox.addEventListener('change', toggleFields2);
        toggleFields2();
    });
    </script>

    <!-- SweetAlert2 (kalau belum ada di layout global) -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.22.2/dist/sweetalert2.all.min.js"></script>

    <script>
    document.addEventListener('DOMContentLoaded', function() {
        // cari form tambah forum sekretaris
        const form =
            document.querySelector('form[action*="/sekretaris/forum"]') ||
            document.forms[0];
        ...
        form.addEventListener('submit', function(e) {
            if (allowSubmit) return; // biar gak loop setelah konfirmasi
            e.preventDefault();
            ...
            Swal.fire({
                ...
                html: `<span class="font-semibold">Data forum${nama ? ` "<span class='italic'>${nama}</span>"` : ''} akan disimpan.</span>`,
                icon: 'question',
