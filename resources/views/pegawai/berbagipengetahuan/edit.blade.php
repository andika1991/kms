...
<x-app-layout>
        ...
        <form id="edit-artikel-form" method="POST"
            ...
            <div class="xl:col-span-8 w-full flex flex-col gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6">
                    ...
                    <input type="text" name="judul" required value="{{ old('judul', $artikelpengetahuan->judul) }}"
                ...
                <div class="flex flex-col md:flex-row gap-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 w-full">
                        ...
                        <input type="text" name="slug" required value="{{ old('slug', $artikelpengetahuan->slug) }}"
                            class="w-full rounded-xl border border-gray-300 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
    ...
    document.getElementById('btn-update-artikel').addEventListener('click', function() {
        Swal.fire({
            ...
            if (r.isConfirmed) document.getElementById('edit-artikel-form').submit();
        });
    });
        ...
        Swal.fire({
            ...
            if (r.isConfirmed) {
                window.location.href =
                    "{{ route('pegawai.berbagipengetahuan.show', $artikelpengetahuan->id) }}";
            }
        });
    });
    </script>
