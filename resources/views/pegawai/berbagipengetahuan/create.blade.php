...
<x-app-layout>
    <div class="w-full min-h-screen bg-[#eaf5ff] pb-32">
        ...
        {{-- PESAN ERROR VALIDASI (UI seragam) --}}
        @if ($errors->any())
        ...
        {{-- FORM TAMBAH ARTIKEL (struktur & logic tetap) --}}
        <form id="form-create-artikel-pegawai" method="POST" action="{{ route('pegawai.berbagipengetahuan.store') }}"
            ...
            <aside class="xl:col-span-4 w-full flex flex-col gap-6">
                ...
                {{-- Tombol Aksi (pakai SweetAlert 2 konfirmasi) --}}
    ...
    {{-- SweetAlert2 terbaru (v11.22.3) --}}
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.22.3/dist/sweetalert2.all.min.js"></script>
    <script>
        document.getElementById('btn-simpan-artikel').addEventListener('click', function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.getElementById('form-create-artikel-pegawai').submit();
                }
            });
        });
    </script>
