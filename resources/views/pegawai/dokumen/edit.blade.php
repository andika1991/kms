        ...
        <div class="p-4 md:p-8 grid grid-cols-1 xl:grid-cols-12 gap-8">
                        ...
                        <div class="flex flex-col">
                            <div class="rounded-2xl border bg-white overflow-hidden">
                                ...
                                <div class="px-4 py-3 text-xs text-gray-600 border-t">
                                    File saat ini: <a href="{{ asset($filePath) }}" target="_blank"
                            ...
                            <div class="mt-4">
                                ...
                                @endif
                                <p class="text-xs text-gray-500 mt-1">Biarkan kosong jika tidak ingin mengganti file.
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            <form id="form-edit-dokumen" method="POST"
                                ...
                                <div id="encrypted-key-field"
                                    ...
                                    <label class="block font-semibold text-gray-800 mb-1">Kunci Rahasia / Encrypted
                                        Key</label>
            ...
            <aside class="xl:col-span-4 w-full flex flex-col gap-8 mt-2 xl:mt-0">
                ...
                <div class="flex flex-col md:flex-row xl:flex-col items-center gap-4">
                    ...
                    {{-- Batalkan --}}
                    <a id="btn-cancel" href="{{ route('pegawai.manajemendokumen.index') }}"
