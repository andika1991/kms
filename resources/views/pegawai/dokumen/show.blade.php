    ...
    <div class="py-8 max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-900 shadow-xl rounded-3xl p-8 transition-colors duration-500">
            ...
            <div class="flex justify-between items-center mb-6">
                    @if(session('success'))
            <div class="mb-6 px-4 py-3 rounded-lg bg-green-100 text-green-800 font-semibold shadow-md">
                {{ session('success') }}
            </div>
        @endif
        ...
        {{-- Notifikasi Error --}}
        @if($errors->any())
            <div class="mb-6 px-4 py-3 rounded-lg bg-red-100 text-red-800 font-semibold shadow-md">
        ...
        <h1 class="text-3xl font-extrabold text-gray-900 dark:text-gray-100 leading-tight max-w-[80%]">
