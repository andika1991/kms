        ...
        <div class="p-4 md:p-8 grid grid-cols-1 xl:grid-cols-12 gap-8">
                    ...
                    <div class="mt-4 flex items-end justify-between gap-6">
                        ...
                        <div class="flex flex-col items-end gap-2">
                            <div class="flex items-center gap-1 text-gray-500 text-sm">
                                <span class="font-semibold">{{ $viewers->count() }}</span>
                        ...
                        <div>
                            @if ($dokumen->path_dokumen && \Illuminate\Support\Facades\Storage::disk('public')->exists($dokumen->path_dokumen))
                                ...
                                @elseif(in_array($ext, ['jpg','jpeg','png','webp','gif','bmp']))
                                    ...
                                    />
                                @else
                                    <div class="flex flex-col items-center justify-center h-72 bg-gray-50 rounded-xl border shadow">
                                ...
                                <div class="mt-3 flex flex-wrap gap-3">
                                    <a
                                        href="{{ asset('storage/'.$dokumen->path_dokumen) }}"
                                        target="_blank"
                                        download
            ...
            <aside class="xl:col-span-4 w-full flex flex-col gap-8 mt-8 xl:mt-0">
                ...
                <div class="flex flex-col gap-3">
                    <a
                        href="{{ route('pegawai.manajemendokumen.edit', $dokumen->id) }}"
                    ...
                    <a
                        href="{{ route('pegawai.manajemendokumen.index') }}"
            ...
            btnCopy.addEventListener('click', async () => {
                ...
                try {
                    ...
                    Swal.fire({
                        ...
                        customClass: { popup: 'rounded-xl shadow-md px-6 py-4' }
                    });
                } catch (e) {
                    Swal.fire({
                        icon: 'error',
