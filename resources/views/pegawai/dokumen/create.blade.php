...
<x-app-layout>
    <div class="w-full min-h-screen bg-[#eaf5ff] flex flex-col pb-10">
        ...
        <div class="px-4 md:px-8 grid grid-cols-1 xl:grid-cols-12 gap-8 mt-6">
            <form id="form-tambah-dokumen" method="POST" action="{{ route('pegawai.manajemendokumen.store') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start min-h-[480px]">
                    ...
                    <div class="flex flex-col gap-5 w-full">
                        ...
                        {{-- Encrypted Key (muncul hanya untuk kategori Rahasia) --}}
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Tampilkan field kunci jika kategori Rahasia
        function toggleKey() {
                ...
                if (ext === 'pdf') {
                    ...
                    filePreview.innerHTML =
                        `<div class="w-full h-full overflow-auto">
                                <embed src="${url}" type="application/pdf" class="w-full h-[480px] rounded pointer-events-auto select-text" style="max-height:480px;" />
                             </div>`;
                } else {
                    // Icon sederhana untuk selain PDF
                    let icon = '';
