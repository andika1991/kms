        ...
        <div class="p-6 md:p-8 grid grid-cols-1 xl:grid-cols-12 gap-8 flex-grow">
            ...
            <section class="xl:col-span-8 w-full">
                ...
                @forelse($grupchats as $grupchat)
                    {{-- Card forum --}}
                    <div class="block bg-white rounded-2xl shadow-lg border border-gray-200/80 p-6 mb-6 hover:shadow-xl hover:border-blue-300 transition-all duration-300">
            ...
            <aside class="xl:col-span-4 w-full flex flex-col gap-8">
                {{-- Kartu Aksi --}}
                <div class="bg-white rounded-2xl shadow-lg p-7 space-y-3 hidden xl:block">
                    <a href="{{ route('pegawai.forum.create') }}"
                        class="w-full flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-green-600 hover:bg-green-700 text-white font-semibold shadow-sm transition text-base">
                        <i class="fa-solid fa-plus"></i>
                        <span>Tambah Forum</span>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-7">
                    <p class="text-sm text-gray-600 leading-relaxed">
                        Forum Diskusi adalah fitur untuk saling berbagi pengetahuan dan komunikasi antar pegawai di Diskominfotik Lampung secara terstruktur dan mudah diakses.
                    </p>
                </div>
            </aside>
        </div>
