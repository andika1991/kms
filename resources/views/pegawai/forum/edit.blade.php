...
@section('title', 'Edit Forum Diskusi Pegawai')
...
<x-app-layout>
        ...
        <div class="flex flex-col lg:flex-row gap-8 px-4 md:px-12 pt-8 pb-10 flex-1 w-full max-w-7xl mx-auto">
            ...
            <form method="POST"
                ...
                <div>
                    ...
                    {{-- Grup Role (opsional) --}}
                    <label for="grup_role" class="block text-gray-700 font-semibold mb-2">Role (Opsional)</label>
                    <input id="grup_role" type="text" name="grup_role" placeholder="Role (Opsional)"
                ...
                {{-- Private --}}
                <div class="mb-2 flex items-center gap-2 bg-white rounded-xl px-5 py-2 shadow">
                ...
                <div id="users-field"
                    ...
                    <small class="text-gray-500">Ketik untuk mencari dan pilih beberapa anggota sekaligus.</small>
                </div>
            ...
            <aside class="w-full lg:w-80 flex flex-col gap-6 mt-8 lg:mt-0">
                ...
                <div class="flex gap-3 mt-2">
                    <button type="submit" form="edit-forum-pegawai"
    ...
    {{-- TomSelect init + toggle bidang/private --}}
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function (e) {
                ...
                Swal.fire({
                    ...
                    html: `<span class="font-semibold">Perubahan${nama ? ` untuk "<span class='italic'>${nama}</span>"` : ''} akan disimpan.</span>`,
                    icon: 'question',
    ...
    {{-- Sedikit styling untuk TomSelect & toggle switch --}}
    <style>
