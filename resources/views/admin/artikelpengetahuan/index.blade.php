        ...
        <div class="p-6 md:p-8 border-b border-gray-200 bg-[#eaf5ff]">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex items-center gap-4 mt-4 sm:mt-0 w-full sm:w-auto">
                    {{-- Search Bar --}}
                    <form method="GET" action="{{ route('admin.berbagipengetahuan.index') }}"
            ...
            <aside class="xl:col-span-4 w-full flex flex-col gap-8">
                <div x-data="{ showDeleteModal: false, deleteAction: '', deleteName: '' }" class="relative">
                    ...
                    <div class="flex flex-col gap-3 mt-6 mb-2">
                        <a href="{{ route('admin.berbagipengetahuan.create') }}"
                        ...
                        <a href="{{ route('admin.kategoripengetahuan.create') }}"
                        ...
                        <ul class="space-y-2">
                            ...
                            <li class="flex items-center justify-between group">
                                ...
                                <span class="flex gap-1 opacity-70 group-hover:opacity-100 transition">
                                    <a href="{{ route('admin.kategoripengetahuan.edit', $kat->id) }}"
                                    ...
                                    <button type="button"
                                        @click="showDeleteModal=true; deleteAction='{{ route('admin.kategoripengetahuan.destroy', $kat->id) }}'; deleteName='{{ $kat->nama_kategoripengetahuan }}';"
