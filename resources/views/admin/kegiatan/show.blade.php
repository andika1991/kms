...
@section('title', 'Detail Kegiatan Admin')
    ...
    <div class="w-full min-h-screen bg-[#eaf5ff] pb-12">
        ...
        <div class="p-6 md:p-8 border-b border-gray-200 bg-[#eaf5ff]">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 class="text-2xl sm:text-3xl font-bold text-gray-800">Detail Kegiatan || Administrator</h2>
        ...
        <div class="p-6 md:p-8 grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <section class="xl:col-span-8 w-full">
                <div class="bg-white rounded-2xl shadow-lg p-6 md:p-10 flex flex-col gap-6">
                    ...
                    <img src="{{ asset('storage/' . $kegiatan->fotokegiatan[0]->path_foto) }}"
            ...
            <aside class="xl:col-span-4 w-full flex flex-col gap-8 mt-8 xl:mt-0">
                ...
                <div
                    ...
                    <p class="font-bold text-lg leading-tight mb-2">
                        Bidang {{ Auth::user()->role->nama_role ?? 'Administrator' }}</p>
                </div>
                {{-- Tombol Aksi --}}
