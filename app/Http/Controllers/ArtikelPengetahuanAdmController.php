...
class ArtikelPengetahuanAdmController extends Controller
{
     ...
     * PERBAIKAN: Mengubah nama variabel $artikelpengetahuan menjadi $berbagipengetahuan
     * agar cocok dengan nama parameter route resource.
     */
    public function show(ArtikelPengetahuan $berbagipengetahuan)
    {
        ...
        return view('admin.artikelpengetahuan.show', [
            'artikel' => $berbagipengetahuan // Variabel 'artikel' tetap dikirim ke view
        ]);
    }

    /**
     * Tampilkan form edit artikel.
     * PERBAIKAN: Menggunakan Route Model Binding dengan variabel $berbagipengetahuan.
     */
    public function edit(ArtikelPengetahuan $berbagipengetahuan)
    {
        $kategori = KategoriPengetahuan::all();
        return view('admin.artikelpengetahuan.edit', [
            'artikelpengetahuan' => $berbagipengetahuan, // Nama di view tetap sama
            'kategori' => $kategori
        ]);
    }
     ...
     * PERBAIKAN: Menggunakan Route Model Binding dengan variabel $berbagipengetahuan.
     */
    public function destroy(ArtikelPengetahuan $berbagipengetahuan)
    {
        if ($berbagipengetahuan->thumbnail && Storage::disk('public')->exists($berbagipengetahuan->thumbnail)) {
            Storage::disk('public')->delete($berbagipengetahuan->thumbnail);
        }
