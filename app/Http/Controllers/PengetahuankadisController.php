...
class PengetahuankadisController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('kadis.berbagipengetahuan.index', compact('artikels', 'kategoriPengetahuans'));
    }
    ...
    public function create()
    {
        ...
        return view('kadis.berbagipengetahuan.create', compact('kategori'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('kadis.berbagipengetahuan.edit', compact('artikelpengetahuan', 'kategori'));
    }
