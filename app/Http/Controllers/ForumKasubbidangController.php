...
class ForumKasubbidangController extends Controller
{
  public function index()
{
    ...
    return view('kasubbidang.forum.index', compact('grupchats'));
}
...
public function create()
{
    ...
    return view('kasubbidang.forum.create', compact('users', 'bidangs'));
}
...
public function edit($id)
{
 ...
 $users = User::whereHas('role', function ($query) use ($roleId, $bidangId) {
    ...
    return view('kasubbidang.forum.edit', compact('grupchat', 'users', 'anggota_ids', 'bidangs'));
}
